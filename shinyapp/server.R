...
my_server <- function(input, output, session) {
  ...
  output$sumStatement <- renderText({
    ...
    return(paste0("In ", input$movie, " there are ", totalChar, " characters and ", totalWords, " spoken. There are ",
           femaleChar, " female characters that say a total of ", fWordsTotal, " words. There are ", 
           maleChar, " male characters that say a total of ", mWordsTotal, " words"))
  })
